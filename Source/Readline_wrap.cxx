...
#define SWIGTYPE_p_Reader swig_types[0]
...
#define SWIGV8_INIT reader_initialize


SWIGV8_ClientData _exports_Reader_clientData;


static SwigV8ReturnValue _wrap_new_Reader(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  int alloc1 = 0 ;
  Reader *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_Reader.");
  if(args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_Reader.");
  res1 = SWIG_AsCharPtrAndSize(args[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_Reader" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);result = (Reader *)new Reader((char const *)arg1);
  
  if (alloc1 == SWIG_NEWOBJ) delete[] buf1;
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_Reader, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_Reader(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    Reader * arg1 = (Reader *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static SwigV8ReturnValue _wrap_Reader_ReadLine(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Reader_ReadLine.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Reader, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Reader_ReadLine" "', argument " "1"" of type '" "Reader *""'"); 
  }
  arg1 = reinterpret_cast< Reader * >(argp1);result = (arg1)->ReadLine();
...
static SwigV8ReturnValue _wrap_Reader_HasNextLine(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Reader_HasNextLine.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Reader, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Reader_HasNextLine" "', argument " "1"" of type '" "Reader *""'"); 
  }
  arg1 = reinterpret_cast< Reader * >(argp1);result = (bool)(arg1)->HasNextLine();
...
static swig_type_info _swigt__p_Reader = {"_p_Reader", "p_Reader|Reader *", 0, 0, (void*)0, 0};
...
#endif
{
  ...
  /* Name: _exports_Reader, Type: p_Reader, Dtor: _wrap_delete_Reader */
SWIGV8_FUNCTION_TEMPLATE _exports_Reader_class = SWIGV8_CreateClassTemplate("_exports_Reader");
SWIGV8_SET_CLASS_TEMPL(_exports_Reader_clientData.class_templ, _exports_Reader_class);
_exports_Reader_clientData.dtor = _wrap_delete_Reader;
if (SWIGTYPE_p_Reader->clientdata == 0) {
  SWIGTYPE_p_Reader->clientdata = &_exports_Reader_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_Reader_class, "ReadLine", _wrap_Reader_ReadLine);
SWIGV8_AddMemberFunction(_exports_Reader_class, "HasNextLine", _wrap_Reader_HasNextLine);
  ...
  /* class instances */
  /* Class: Reader (_exports_Reader) */
SWIGV8_FUNCTION_TEMPLATE _exports_Reader_class_0 = SWIGV8_CreateClassTemplate("Reader");
_exports_Reader_class_0->SetCallHandler(_wrap_new_Reader);
_exports_Reader_class_0->Inherit(_exports_Reader_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_Reader_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_Reader_obj = _exports_Reader_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_Reader_obj = _exports_Reader_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("Reader"), _exports_Reader_obj));
...
NODE_MODULE(reader, reader_initialize)
#else
NODE_MODULE_CONTEXT_AWARE(reader, reader_initialize)
#endif
#endif
